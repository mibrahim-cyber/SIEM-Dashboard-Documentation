...
(function (global) {
  ...
  /* ── AchievementSystem (24) ── */
  var ACH_DEFINITIONS = [
    { id: 'first_boot', title: 'Cold Start', desc: 'Boot the terminal for the first time.', icon: '⬡' },
    { id: 'visit_terminal', title: 'Shell Access', desc: 'Enter The Terminal.', icon: '▸' },
    { id: 'visit_breach', title: 'Red Team', desc: 'Enter The Breach simulation.', icon: '◈' },
    { id: 'visit_network', title: 'Ghost Walker', desc: 'Enter The Ghost Network.', icon: '◎' },
    { id: 'visit_cipher', title: 'Cryptographer', desc: 'Enter The Cipher vault.', icon: '⬢' },
    { id: 'visit_sim', title: 'War Games', desc: 'Enter The Simulation.', icon: '◉' },
    { id: 'visit_intercept', title: 'Interrogator', desc: 'Enter The Interrogation Room.', icon: '◫' },
    { id: 'visit_forge', title: 'Rule Smith', desc: 'Enter The Forge.', icon: '⬛' },
    { id: 'visit_archive', title: 'Archivist', desc: 'Enter The Deep Archive.', icon: '▣' },
    { id: 'visit_heist', title: 'Inside Job', desc: 'Enter The Heist.', icon: '◆' },
    { id: 'visit_cartography', title: 'Cartographer', desc: 'Enter The Cartography globe.', icon: '◐' },
    { id: 'visit_lab', title: 'Lab Rat', desc: 'Enter The Lab.', icon: '⬤' },
    { id: 'visit_memorial', title: 'Remembrance', desc: 'Enter The Memorial.', icon: '◌' },
    { id: 'visit_resonance', title: 'Resonance', desc: 'Enter The Resonance board.', icon: '♫' },
    { id: 'visit_brain', title: 'Observation Deck', desc: 'Visit the brain deck.', icon: '◑' },
    { id: 'visit_warroom', title: 'War Room', desc: 'Enter The War Room.', icon: '◒' },
    { id: 'visit_signal', title: 'Signal Lock', desc: 'Enter The Signal Room.', icon: '◓' },
    { id: 'palette_open', title: 'Command Line', desc: 'Open the global command palette.', icon: '⌘' },
    { id: 'egg_secret', title: 'SIEM_SECRET', desc: 'Discover the SIEM_SECRET easter egg.', icon: '★' },
    { id: 'egg_habibi', title: 'man habibi', desc: 'Read the habibi manual page.', icon: '☆' },
    { id: 'breach_win', title: 'Containment', desc: 'Complete a breach scenario.', icon: '✓' },
    { id: 'cipher_alpha', title: 'Alpha Chamber', desc: 'Solve the ALPHA cipher puzzle.', icon: 'Α' },
    { id: 'deck_transition', title: 'Phase Shift', desc: 'Cycle deck transition styles.', icon: '↻' },
    { id: 'explorer', title: 'Full Tour', desc: 'Visit 10 distinct deck pages.', icon: '✦' },
  ];
  ...
  var AchievementSystem = {
    ...
    list: function () {
      ...
      return ACH_DEFINITIONS.map(function (a) {
        return { id: a.id, title: a.title, desc: a.desc, icon: a.icon, unlocked: !!u[a.id], at: u[a.id + '_at'] || null };
      });
    },
