...
Tags like `data`, `auth`, `public` indicate control applicability. `public` assets imply internet exposure requiring WAF/monitoring controls. Tags represent the classification assigned during asset registration and should be kept current as asset roles change.
