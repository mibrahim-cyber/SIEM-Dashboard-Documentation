...
This page documents **watchlist-only enforcement** as implemented in HABIBI-SIEM for coursework and small-team SOC labs.

## Role in the platform

Watchlist-only enforcement sits in the split architecture where the browser runs detection and visualization while the API holds secrets, sessions, and SQLite persistence. Understanding this piece prevents misconfigured labs and false bug reports during demos.
...
- [Guide index](../../guides/ingest-config/settings/INDEX.md)## Lab verification
