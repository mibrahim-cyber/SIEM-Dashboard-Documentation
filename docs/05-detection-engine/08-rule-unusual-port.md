﻿# Rule: Unusual port contact

Bundled detection in HABIBI-SIEM. Severity **medium**, category **network**, MITRE **T1571** (Command and control).

## Intent

Alerts when logs show connections to non-standard ports for the environment baseline.
