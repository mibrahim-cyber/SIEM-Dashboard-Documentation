# Rule: Rapid HTTP requests

Bundled detection in HABIBI-SIEM. Severity **medium**, category **network**, MITRE **T1499** (Impact).

## Intent

Flags burst request rates indicative of scraping or application-layer DoS in lab traffic.
