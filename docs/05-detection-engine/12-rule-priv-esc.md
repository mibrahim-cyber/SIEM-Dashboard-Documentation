...
Bundled detection in HABIBI-SIEM. Severity **critical**, category **host**, MITRE **T1068** (Privilege escalation).

## Intent

Detects sudo to root, runas admin, or role change phrases in auth logs.
