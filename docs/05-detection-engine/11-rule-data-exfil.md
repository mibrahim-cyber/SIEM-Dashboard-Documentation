# Rule: Data exfiltration patterns

Bundled detection in HABIBI-SIEM. Severity **critical**, category **exfiltration**, MITRE **T1048** (Exfiltration).

## Intent

Large outbound transfer wording or suspicious upload success paired with size hints.

## What analysts see

Alerts name this rule in matched rules list with severity badge coloured to critical. Rules Engine card shows hit count and MITRE block for briefing slides.
