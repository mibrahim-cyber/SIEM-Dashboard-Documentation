...
Bundled detection in HABIBI-SIEM. Severity **high**, category **authentication**, MITRE **T1110** (Credential access).

## Intent

Stateful counter: five or more failed authentication events from one source IP inside sixty seconds.

## What analysts see

Alerts name this rule in matched rules list with severity badge coloured to high. Rules Engine card shows hit count and MITRE block for briefing slides.
