...
(function () {
  ...
  var config = {
    ...
    1: {
      ...
      tasks: [{
        ...
        output: '[OK] ROTATE WHEEL executed — Decrypt shift cipher via wheel',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }],
      branch: {
        title: 'Decision point — Level 1',
        desc: 'Your Cryptographic attack recognition approach affects the next phase.',
        options: [
    ...
    2: {
      ...
      tasks: [{
        ...
        errorType: 'wrong_command',
        validate: function () { return true; },
        output: '[OK] MAP FREQ executed — Break substitution with frequency chart',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }],
      branch: {
    ...
    3: {
      ...
      tasks: [{
        ...
        errorType: 'wrong_command',
        validate: function () { return true; },
        output: '[OK] SET ROTORS executed — Configure rotor positions',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }],
      branch: {
    ...
    4: {
      ...
      tasks: [{
        ...
        errorType: 'wrong_command',
        validate: function () { return true; },
        output: '[OK] FACTOR N executed — Factor modulus to derive private key',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }]
    }
  ...
  var PLAYBOOK_TITLE = 'THE CIPHER — operator runbook';
  var CORE_CONCEPT = 'Cryptographic attack recognition';
  var LEVEL_BRIEFINGS = {
    1: {
