...
(function () {
  ...
  function buildScene(engine, level, shell) {
    ...
    var core = engine.addBox(0, 0.5, 0, 1.2, 1.0, 1.2, parseInt('0x020617', 16));
  ...
  var config = {
    ...
    1: {
      ...
      tasks: [{
        ...
        output: '[OK] INJECT BRUTE executed — Trigger failed_auth rule',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }],
      branch: {
        title: 'Decision point — Level 1',
        desc: 'Your Malware analysis and sandboxing approach affects the next phase.',
        options: [
    ...
    2: {
      ...
      tasks: [{
        ...
        errorType: 'wrong_command',
        validate: function () { return true; },
        output: '[OK] INJECT SQLI executed — Fire SQLi payload — observe alert',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }],
      branch: {
    ...
    3: {
      ...
      tasks: [{
        ...
        errorType: 'wrong_command',
        validate: function () { return true; },
        output: '[OK] INJECT XSS executed — XSS payload in search form',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }],
      branch: {
    ...
    4: {
      ...
      tasks: [{
        ...
        errorType: 'wrong_command',
        validate: function () { return true; },
        output: '[OK] CORRELATE executed — Three identical payloads → correlation',
        onSuccess: function (shell) { shell.score += 100; shell.updateScore(); }
      }]
    }
  ...
  var PLAYBOOK_TITLE = 'THE LAB — operator runbook';
  var CORE_CONCEPT = 'Malware analysis and sandboxing';
  var LEVEL_BRIEFINGS = {
    1: {
